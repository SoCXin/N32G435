...
3、使用说明
	...
	2、GPIO：PA8 选择作为外部中断入口，PA9 控制 LED(D2) 常亮，PA10 控制 LED(D3) 闪烁
...
2. Use environment
	...
	1.Developed based on the evaluation board NS3602_LQFP100_V0.1
	
3. Instructions for use
    /* Describe the related module configuration method; For example: clock, I/O, etc. */
	1. SystemClock: 108 MHZ
	2. GPIO: PA8 is selected as the external interrupt entrance. PA9 controls LED(D2) to be on, and PA10 controls LED(D3) to blink.
